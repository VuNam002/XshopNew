...
function CreateCategory () {
    ...
    const apiRequest = async (URL, options = {}) => {
        ...
        return text ? JSON.parse(text) : null; // Xử lý trường hợp response rỗng
    }
    ...
    const handleFileSelect = (e) => {
        ...
        // Fix: đã sửa lỗi typo 'sizw' thành 'size'
        ...
        // Fix: sửa reader.error thành reader.onerror
        reader.onerror = () => {
        ...
        <div className="min-h-screen p-6 bg-gray-50">
            <div className="max-w-4xl p-8 mx-auto bg-white rounded-lg shadow-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    {/* Tên danh mục */}
                    <div>
                        <label htmlFor="name" className="block mb-1 text-sm font-medium text-gray-700">Tên danh mục</label>
                        <input
                         type="text"
                         id="name"
                         name="name"
