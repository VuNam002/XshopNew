...
function CategoryBlog() {
  ...
  const API_BASE = "http://localhost:3000/category-blog";
  ...
  const handleDeleteSingle = async (categoryId, categoryName) => {
    ...
    try {
      await apiRequest(`${API_BASE}/delete/${categoryId}`, {
        method: "DELETE",
      });
  ...
  const handleBulkAction = async (action) => {
    ...
    try {
      ...
      if (action === "delete") {
        setCategory((prev) =>
          prev.filter((p) => !selectedCategory.includes(p._id))
        );
      } else {
        setCategory((prev) =>
          prev.map((p) =>
        ...
        <div className="bg-white border border-gray-200 rounded-lg">
          ...
          <div className="px-6 py-4 border-b border-gray-200">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                onClick={() =>
                  (window.location.href = "/admin/category-blog/create")
                }
                        ...
                        <tr key={cat._id} className="hover:bg-gray-50">
                          <td className="px-6 py-4">
                            <input
                              ...
                              onChange={(e) =>
                                handleSelectCategory(cat._id, e.target.checked)
                              }
                              className="text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                            />
                          </td>
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-2">
                              <button
                                onClick={() =>
                                  (window.location.href = `/admin/category-blog/edit/${cat._id}`)
                                }
                              ...
                              <button
                                onClick={() =>
                                  (window.location.href = `/admin/category/detail/${cat._id}`)
                                }
